...
">
	...
	<div id="formFooter">
      <a class="underlineHover" href="<?php echo base_url().'auth/daftaruser'?>">DAFTAR</a><br><br>
      <a class="underlineHover" href="<?php echo base_url().'auth/lupapassword'?>">LUPA PASSWORD</a>
    </div>
